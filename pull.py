...
econst = []
vvalue = []
offset = onp.random.randint(1,70,size=500)
...
onp.savez("fit_result",f0m=vf0m,f0w=vf0w,const=vconst,value=vvalue,offset=offset,ef0m=ef0m,ef0w=ef0w,econst=econst)
